...
class ml1m(Dataset):
    ...
    max_length = 10
    num_features = 3679
    feat_names = ['age', 'occupation', 'zipcode', 'release_year', 'genre', 'hour', 'day', 'weekday', 'month', 'year']
    feat_min = [0, 7, 28, 3467, 3567, 3585, 3609, 3640, 3647, 3659]
    feat_max = [6, 27, 3466, 3566, 3584, 3608, 3639, 3646, 3658, 3678]
    feat_sizes = [7, 21, 3439, 100, 18, 24, 31, 7, 12, 20]
    data_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data/ml1m')
